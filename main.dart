...
/* appBar: AppBar(
          title: Row(actions: <Widget>[IconButton(icon: Icon(Icons.dehaze),
            onPressed: (){
              // ESSE BOTÃO CHAMA A TELA DRAWER
            },
          )
          ],
          ),
        ...
        body: Container(
           ...
           body: new Container(
             ...
             child: new Row(
                 ...
                 children: <Widget>[
                   Text("Adicionar uma imagem...", style: TextStyle(fontSize: 14, fontWeight: FontWeight.bold)),
                   new IconButton(icon: Icon(Icons.file_upload),
                     onPressed: (){
                       // ESSE BOTÃO faz o upload de foto
                     },
                   color: Colors.grey,
           ),
      ],
